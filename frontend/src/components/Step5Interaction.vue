      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            <span class="action-bar-title">Инструменты взаимодействия</span>
            <span class="action-bar-subtitle mono">Доступно участников: {{ profiles.length }}</span>
          </div>
        </div>
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Диалог с модулем отчета</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Диалог с любым участником мира' }}</span>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Неизвестная роль' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>Отправить опрос в мир симуляции</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">Модуль отчета</div>
                <div class="tools-card-subtitle">Быстрый режим диалога с модулем отчета, четырьмя специализированными инструментами и полной памятью MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">Глубокий анализ: разбор причин</div>
                    <div class="tool-desc">Сопоставляет исходные данные с состоянием симуляции и через глобальную и локальную память строит причинно-следственный анализ</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">Панорамный поиск: обзор развития</div>
                    <div class="tool-desc">Использует обход графа, восстанавливает путь распространения событий и показывает топологию информационных потоков</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">Быстрый поиск: адресные факты</div>
                    <div class="tool-desc">Мгновенный GraphRAG-запрос для быстрого извлечения свойств узлов и отдельных фактов</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">Интервью с агентами: живые мнения</div>
                    <div class="tool-desc">Проводит параллельные многошаговые интервью с участниками мира и собирает неструктурированные мнения и психологические состояния</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'Неизвестная роль' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Кратко</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Обсудите отчет с модулем отчета' : 'Поговорите с агентом симуляции и узнайте его точку зрения' }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? 'Вы' : (chatTarget === 'report_agent' ? 'Модуль отчета' : (selectedAgent?.username || 'Агент')) }}
                  </span>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Выберите участников опроса</span>
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'Неизвестная роль' }}</span>
                  </div>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Вопрос опроса</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Введите вопрос, который хотите задать всем выбранным участникам..."
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>Отправить опрос</span>
            </button>
          </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'Неизвестная роль' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // Кэш истории диалогов: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
// Сохранить текущий диалог в кэш
...
const selectReportAgentChat = () => {
  ...
  // Восстановить диалог с Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Восстановить диалог с этим агентом
...
const renderMarkdown = (content) => {
  ...
  // Оборачиваем маркированные списки
  html = html.replace(/(<li class="md-li"[^>]*>.*?<\/li>\s*)+/g, '<ul class="md-ul">$&</ul>')
  // Оборачиваем нумерованные списки
  html = html.replace(/(<li class="md-oli"[^>]*>.*?<\/li>\s*)+/g, '<ol class="md-ol">$&</ol>')
  
  // Убираем лишние пробелы между пунктами списка
  html = html.replace(/<\/li>\s+<li/g, '</li><li')
  // Убираем пробелы после открывающих тегов списков
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Убираем пробелы перед закрывающими тегами списков
  ...
  // Убираем лишние пустые строки перед блочными элементами
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Убираем повторяющиеся <br>
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Убираем <br> между блочным элементом и следующим абзацем
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Сохраняем корректную нумерацию разорванных списков
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Автоматически сохраняем историю в кэш
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(`Отправка в модуль отчета: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Модуль отчета ответил')
  } else {
    throw new Error(res.error || 'Запрос завершился ошибкой')
  }
}

const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Сначала выберите агента симуляции')
  }
  
  addLog(`Отправка агенту ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Пользователь' : 'Собеседник'}: ${msg.content}`)
      .join('\n')
    prompt = `Ниже приведен фрагмент нашего предыдущего диалога:\n${historyContext}\n\nНовый вопрос:\n${message}`
  }
  ...
  if (res.success && res.data) {
    // Правильный путь: res.data.result.results содержит словарь объектов
    // Формат: {"twitter_0": {...}, "reddit_0": {...}} или {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Преобразуем словарь в ответ, отдавая приоритет reddit
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Сначала берем ответ reddit, затем twitter
      ...
      // Поддержка ответа в виде массива
    ...
    if (responseContent) {
      ...
      throw new Error('В ответе нет данных')
    }
  } else {
    throw new Error(res.error || 'Запрос завершился ошибкой')
  }
...
const submitSurvey = async () => {
  ...
  addLog(`Отправка опроса ${selectedAgents.value.size} участникам...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Преобразуем словарь в массив результатов
      ...
      for (const interview of interviews) {
        ...
        surveyResultsList.push({
          agent_id: agentIdx,
          agent_name: agent?.username || `Участник ${agentIdx + 1}`,
    ...
    addLog(`Не удалось отправить опрос: ${err.message}`)
  } finally {
...
const loadReportData = async () => {
  ...
  try {
    addLog(`Загрузка данных отчета: ${props.reportId}`)
    ...
    addLog(`Не удалось загрузить отчет: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('Данные отчета загружены')
    }
  } catch (err) {
    addLog(`Не удалось загрузить логи отчета: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Загружено ${profiles.value.length} агентов симуляции`)
    }
  } catch (err) {
    addLog(`Не удалось загрузить агентов симуляции: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Инициализация шага 5: глубокое взаимодействие')
  loadReportData()
  loadProfiles()
